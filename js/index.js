...
!(function(){
    ...
    //将a的容器转换为数组
    let aContainerNodes = Array.prototype.slice.call(document.querySelector(".line h2").children)
    
    function aClick( e ){
        // console.log(aContainerNodes)
        // console.log(e.target)
        // console.log(aContainerNodes.indexOf(e.target))
        //找到a在容器中的索引，对应数据的索引
        let index = aContainerNodes.indexOf(e.target)
        ...
        series: [
            {
                name:"年龄分布",
                type: 'pie',
                //饼形图通过radius修改大小 ， 折线图，柱状图通过grid修改大小
                radius: ['40%', '60%'],
                center: ["50%", "42%"],
                label: {
                    show: false,
